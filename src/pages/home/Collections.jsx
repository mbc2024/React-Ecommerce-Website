    ...
    <div className='bg-[url("/images/collection-bg.png")] bg-cover bg-center bg-no-repeat xl:px-28 px-4 my-20'>
        <div className="h-[580px] flex justify-between md:flex-row items-center">
            ...
            <div className="md:w-1/2">
                ...
                <p className="text-lg text-white capitalize my-8 md:w-2/3 leading-[32px]">Elevate your style with Zara's chic, trend-setting fashion: timeless, bold, and effortlessly sophisticated.</p>
