...
const Newsletter = () => {
  return (
    <div className='bg-[#1E2832] bg-opacity-5 xl:px-28 px-4 py-16'>
      <h2 className="title mb-8">Stay Insta-Inspired: Follow Us Now for discounts!</h2>
      ...
      <div>
        ...
        <form className="md:w-1/2 mx-auto text-center">
          ...
          <input type="submit" value={"Submit"} className="bg-black text-white px-6 py-1 rounded-sm hover:bg-orange-500" />
        </form>
      </div>
    </div>
  )
